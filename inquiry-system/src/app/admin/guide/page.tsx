    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <section className="bg-white border border-[var(--line)] rounded-xl p-5 space-y-4">
        ...
        <p className="text-sm text-[var(--muted)] leading-relaxed">
          插件装在<strong>各客户 WordPress 网站</strong>上，不在本询盘系统里。未安装/未启用时，WP
          后台不会出现「询盘对接」菜单。
        </p>
        <PluginDownloadCard />
        <ol className="list-decimal pl-5 space-y-2 text-sm leading-relaxed">
          <li>
            下载上方 zip 并解压，把 <code className="bg-black/5 px-1 rounded">wp-inquiry-bridge</code>{" "}
            文件夹放到该站服务器：
            <code className="bg-black/5 px-1 rounded ml-1">
              wp-content/plugins/wp-inquiry-bridge/
            </code>
            （也可用 WP 后台「上传插件」直接上传 zip）。
          </li>
          <li>
