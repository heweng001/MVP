  ...
  return {
    ...
    searchFunnel: {
      ...
      keywordSteps: [
        ...
        { key: "top100", label: "排名前 100", value: 142, prevValue: 130 },
        { key: "top30", label: "排名前 30", value: 68, prevValue: 61 },
      ],
    },
    trafficFunnel: {
      title: "流量与询盘漏斗",
      steps: [
        ...
        { key: "valid", label: "有效询盘", value: 22, prevValue: 18 },
      ],
    },
    topKeywords: [
    ...
    topLandings: [
      {
        pagePath: "/products/ball-valve/",
        sessions: 680,
        engagedSessions: 490,
        conversions: 18,
        engagementRate: 0.72,
        pageViews: 1420,
        avgEngagementTimeSec: 96,
        bounceRate: 0.28,
      },
      {
        pagePath: "/",
        ...
        engagementRate: 0.57,
        pageViews: 980,
        avgEngagementTimeSec: 54,
        bounceRate: 0.41,
      },
      {
        pagePath: "/products/butterfly-valve/",
        sessions: 410,
        engagedSessions: 280,
        conversions: 11,
        engagementRate: 0.68,
      ...
      },
      {
        ...
        engagementRate: 0.81,
        pageViews: 320,
        avgEngagementTimeSec: 112,
        bounceRate: 0.18,
      },
      {
        pagePath: "/blog/valve-selection-guide/",
        sessions: 190,
        engagedSessions: 140,
        conversions: 2,
        engagementRate: 0.74,
        pageViews: 410,
        avgEngagementTimeSec: 148,
        bounceRate: 0.22,
      },
    ],
    topGaPages: [
