...
import { formatMarkRemaining, formatMarkRemainingPlain } from "@/lib/wp-fields";
      ...
      {canMark || marked ? (
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            maxLength={500}
            rows={3}
            placeholder="请备注将此询盘标记为有效或无效的具体原因。"
          ...
          {marked ? (
            <>
              ...
              <span className="text-xs text-[var(--muted)] leading-snug">
                如需修改，请在{formatMarkRemainingPlain(remainingMs)}内进行
              </span>
            </>
          ) : (
            <>
